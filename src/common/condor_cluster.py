...
def add_cluster_args(parser):
    ...
    parser.add_argument("--memory", type=int, default=16000, help="log every k steps")
...
class CondorCluster:
    ...
    def _create_bash_file(self, run_p):
        ...
        PYTHON_CMD = "/home/fzicong/anaconda3/envs/hold_env/bin/python"
        bash = "export PYTHONBUFFERED=1\n"
        bash += f"cd {self.cfg.repo_p}\n"
        bash += f"{PYTHON_CMD} {self.script}"
        bash += " --agent_id $1"
